...
class RunningCartProductData extends DataClass
    implements Insertable<RunningCartProductData> {
  final int id;
  final String onlineID;
  final String name;
  final String code;
  ...
  factory RunningCartProductData.fromData(Map<String, dynamic> data,
      {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return RunningCartProductData(
      id: const IntType()
          .mapFromDatabaseResponse(data['${effectivePrefix}id'])!,
      onlineID: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}online_i_d'])!,
  ...
  RunningCartProductCompanion toCompanion(bool nullToAbsent) {
    return RunningCartProductCompanion(
      id: Value(id),
      onlineID: Value(onlineID),
      name: Value(name),
      code: Value(code),
  ...
  factory RunningCartProductData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return RunningCartProductData(
      id: serializer.fromJson<int>(json['id']),
  ...
  RunningCartProductData copyWith(
          {int? id,
          String? onlineID,
          String? name,
          String? code,
  ...
  @override
  String toString() {
    return (StringBuffer('RunningCartProductData(')
          ..write('id: $id, ')
          ..write('onlineID: $onlineID, ')
          ..write('name: $name, ')
          ..write('code: $code, ')
  ...
  @override
  int get hashCode => Object.hash(id, onlineID, name, code, customCode, typeId,
      purchasePrice, salePrice, cartQty);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is RunningCartProductData &&
          other.id == this.id &&
          other.onlineID == this.onlineID &&
          other.name == this.name &&
          other.code == this.code &&
...
class RunningCartProductCompanion
    extends UpdateCompanion<RunningCartProductData> {
  final Value<int> id;
  final Value<String> onlineID;
  final Value<String> name;
  final Value<String> code;
  ...
  const RunningCartProductCompanion({
    this.id = const Value.absent(),
    this.onlineID = const Value.absent(),
    this.name = const Value.absent(),
    this.code = const Value.absent(),
  ...
  RunningCartProductCompanion.insert({
    this.id = const Value.absent(),
    required String onlineID,
    required String name,
    required String code,
    ...
    required int cartQty,
        ...
        salePrice = Value(salePrice),
        cartQty = Value(cartQty);
  static Insertable<RunningCartProductData> custom({
    Expression<int>? id,
    Expression<String>? onlineID,
    Expression<String>? name,
    Expression<String>? code,
  ...
  RunningCartProductCompanion copyWith(
      {Value<int>? id,
      Value<String>? onlineID,
      Value<String>? name,
      Value<String>? code,
  ...
  @override
  String toString() {
    return (StringBuffer('RunningCartProductCompanion(')
          ..write('id: $id, ')
          ..write('onlineID: $onlineID, ')
          ..write('name: $name, ')
          ..write('code: $code, ')
...
class $RunningCartProductTable extends RunningCartProduct
    with TableInfo<$RunningCartProductTable, RunningCartProductData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $RunningCartProductTable(this.attachedDatabase, [this._alias]);
  final VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int?> id = GeneratedColumn<int?>(
      'id', aliasedName, false,
  ...
  @override
  String get aliasedName => _alias ?? 'running_cart_product';
  @override
  String get actualTableName => 'running_cart_product';
  @override
  VerificationContext validateIntegrity(
      Insertable<RunningCartProductData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  RunningCartProductData map(Map<String, dynamic> data, {String? tablePrefix}) {
    return RunningCartProductData.fromData(data,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }

  @override
  $RunningCartProductTable createAlias(String alias) {
    return $RunningCartProductTable(attachedDatabase, alias);
  }
}
